...
@Mod(AdventureCraftMod.MODID)
public class AdventureCraftMod {
    ...
    public AdventureCraftMod(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = AdventureCraftMod.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
